    ...
    <main className="bg-[#f7f9fc] text-slate-900">
      <section className="pb-6 pt-10">
        <div className="mx-auto max-w-6xl px-5">
          <div className="rounded-[28px] border border-[#d9e3f5] bg-white px-6 py-8 shadow-[0_14px_40px_rgba(22,32,72,0.08)] md:px-10 md:py-10">
            <div className="grid gap-8 lg:grid-cols-[1.65fr_0.95fr]">
              <div>
                <div className="mb-3 text-xs font-semibold uppercase tracking-[0.2em] text-[#2f5bd2]">
                  Germany Visa Guide
                </div>
                ...
                <div className="mt-6 flex flex-wrap gap-3">
                  <a
                    href="#visa-overview"
                    className="inline-flex items-center rounded-full bg-[#2f5bd2] px-5 py-3 text-sm font-semibold text-white transition hover:bg-[#2449ac]"
                  >
                    Explore visa options
                  </a>
                  <a
                    href="#decision-guide"
                    className="inline-flex items-center rounded-full border border-[#d9e3f5] bg-white px-5 py-3 text-sm font-semibold text-slate-900 transition hover:bg-slate-50"
                  >
              ...
              <aside className="rounded-3xl border border-[#d9e3f5] bg-[#f8fbff] p-6">
                <div className="text-sm font-semibold text-[#2f5bd2]">
      ...
      <section className="pb-4">
        <div className="mx-auto grid max-w-6xl gap-4 px-5 md:grid-cols-3">
          {quickFacts.map((fact) => (
            <div
              key={fact.title}
              className="rounded-3xl border border-[#d9e3f5] bg-white p-5 shadow-[0_8px_24px_rgba(22,32,72,0.04)]"
            >
          ...
          <div className="grid gap-5 md:grid-cols-2 xl:grid-cols-3">
            {overviewCards.map((card) => (
              <a
                key={card.title}
                href={`#${card.id}`}
                className="rounded-3xl border border-[#d9e3f5] bg-white p-6 shadow-[0_8px_24px_rgba(22,32,72,0.04)] transition hover:-translate-y-0.5 hover:shadow-[0_14px_40px_rgba(22,32,72,0.08)]"
              >
                ...
                <div className="mt-4 text-sm font-semibold text-[#2f5bd2]">
                  Read summary →
                </div>
              </a>
            ))}
      ...
      <section className="py-2">
        <div className="mx-auto max-w-6xl px-5">
          <div className="rounded-3xl border border-[#f0d9a7] bg-[#fffaf0] p-6">
      ...
      <section id="decision-guide" className="py-10">
        <div className="mx-auto grid max-w-6xl gap-6 px-5 lg:grid-cols-[0.95fr_1.15fr]">
          ...
          <div className="rounded-3xl border border-[#d9e3f5] bg-white p-6 shadow-[0_8px_24px_rgba(22,32,72,0.04)]">
            <div className="space-y-3">
              {personas.map((persona) => (
                <div
                  key={persona}
                  className="rounded-2xl bg-[#f7f9fc] px-4 py-3 text-sm text-slate-700"
                >
                  {persona}
                </div>
              ))}
            ...
            <div className="mt-6 rounded-3xl bg-[#2f5bd2] p-6 text-white">
              ...
              <div className="mt-5">
                <a
                  href="#"
                  className="inline-flex items-center rounded-full bg-white px-5 py-3 text-sm font-semibold text-[#2f5bd2]"
                >
      ...
      <section className="py-10">
        <div className="mx-auto max-w-6xl px-5">
          <div className="grid gap-6 lg:grid-cols-2">
            <article
              id="eu-blue-card"
              className="rounded-3xl border border-[#d9e3f5] bg-white p-6 shadow-[0_8px_24px_rgba(22,32,72,0.04)]"
            >
            ...
            <article
              id="family-reunification"
              className="rounded-3xl border border-[#d9e3f5] bg-white p-6 shadow-[0_8px_24px_rgba(22,32,72,0.04)] lg:col-span-2"
            >
              <h2 className="text-xl font-semibold text-slate-900">
      ...
      <section id="requirements" className="py-10">
        <div className="mx-auto max-w-6xl px-5">
          <div className="grid gap-6 lg:grid-cols-2">
            ...
            <div className="rounded-3xl border border-[#d9e3f5] bg-white p-6 shadow-[0_8px_24px_rgba(22,32,72,0.04)] lg:col-span-2">
              <h2 className="text-xl font-semibold text-slate-900">
      ...
      <section id="long-term-path" className="py-10">
        <div className="mx-auto max-w-6xl px-5">
          <div className="rounded-[28px] border border-[#d9e3f5] bg-white px-6 py-8 shadow-[0_14px_40px_rgba(22,32,72,0.08)] md:px-8">
            <h2 className="text-2xl font-semibold tracking-tight text-slate-900 md:text-3xl">
      ...
      <section className="py-6">
        <div className="mx-auto max-w-6xl px-5">
          <div className="rounded-[28px] bg-[#2f5bd2] px-6 py-8 text-white shadow-[0_14px_40px_rgba(47,91,210,0.25)] md:px-8">
      ...
      <section id="sources" className="pb-14 pt-10">
        <div className="mx-auto max-w-6xl px-5">
          ...
          <div className="mt-6 rounded-3xl border border-[#d9e3f5] bg-white p-6 shadow-[0_8px_24px_rgba(22,32,72,0.04)]">
